...
(function () {
  ...
  function init() {
    ...
    initBusquedaNavbarModal({
      ...
      apiUrl: 'parts/universal/buscar_lote_navbar.php?busqueda=',
      extraerItems: function (data) {
        return data.lotes || [];
      },
      obtenerUrl: function (lote) {
        return lote.identificador
          ? 'lote.php?id=' + encodeURIComponent(String(lote.identificador))
          : '';
      },
    ...
    initBusquedaNavbarModal({
      ...
      apiUrl: 'parts/universal/buscar_articulo_navbar.php?busqueda=',
      extraerItems: function (data) {
        return data.articulos || [];
      },
      obtenerUrl: function (articulo) {
        return articulo.id
          ? 'articulo.php?id=' + encodeURIComponent(String(articulo.id))
          : '';
      },
