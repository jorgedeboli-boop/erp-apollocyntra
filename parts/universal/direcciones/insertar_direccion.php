...
// OBTENER DATOS DE LAS DIRECCIONES
         ...
         $codigo_postal = (int)($_POST['codigo_postal'] ?? 0);
        ...
        $id_direccion = insertarDireccion($id_type_direccion, $type_direccion, $direccion, $provincia_texto, $poblacion_texto, $pais_texto, $codigo_postal, $provincia_id, $pais_id, $poblacion_id, $observaciones_direccion);
        if (!$id_direccion) {
            throw new Exception("Error al insertar la dirección");
        }
?>