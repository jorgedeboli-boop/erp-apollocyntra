<!-- Template: Modal Editar Registro -->
<!-- Uso: Incluir en content.php para editar registros existentes -->
<!-- Variables requeridas: $modal_id, $modal_title, $form_id, $fields, $submit_text, $hidden_field -->
    ...
    <div class="modal-content">
      ...
      <form id="<?php echo $form_id; ?>">
        <div class="modal-body">
          ...
          <input type="hidden" id="<?php echo $hidden_field['id']; ?>" name="<?php echo $hidden_field['name']; ?>">
...
<!-- 
EJEMPLO DE USO:
$modal_id = 'modalEditarTipoGasto';
$modal_title = 'Editar Tipo de Gasto';
$form_id = 'formEditarTipoGasto';
