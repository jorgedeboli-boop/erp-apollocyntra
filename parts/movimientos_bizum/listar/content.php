<div class="container-fluid flex-grow-1 container-p-y">
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="avatar">
              <div class="avatar-initial bg-label-primary rounded-circle">
                <div class="icon-base ri ri-smartphone-line icon-26px"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Movimientos Bizum Table -->
  <div class="card">
    <div class="card-header border-bottom card-header-forms">
      <h5 class="card-title mb-0" id="titulo-listados">Histórico de Movimientos Bizum</h5>
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-movimientos-bizum table border-top">
        <thead>
          <tr>
            <th>ID</th>
            <th>Fecha</th>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalNuevoApunteLabel">Nuevo Movimiento Bizum</h5>
