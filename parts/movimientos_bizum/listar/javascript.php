...
<!-- JAVASCRIPT CUSTOM MOVIMIENTOS BIZUM LISTAR -->
<!-- Scripts personalizados de movimientos bizum -->
<?php
...
<script src="parts/movimientos_bizum/listar/load_stats.js?v=<?php echo $vLoadStats; ?>"></script>
<script src="parts/universal/export-datatable-todos.js?v=<?php echo $vExportDatatableTodos; ?>"></script>
<script src="parts/movimientos_bizum/listar/tables-datatables-load.js?v=<?php echo $vTablesDatatablesLoad; ?>"></script>
