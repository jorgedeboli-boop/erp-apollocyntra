...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_empresas_table) {
    dt_empresas = new DataTable(dt_empresas_table, {
     ...
     // Configuración de idioma español desde archivo externo
     language: DATATABLES_ESPAÑOL,
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            const empresaId = full[0]; // ID de la empresa
            
            return `
              <div class="d-flex align-items-center">
                <a href="empresa.php?id=${empresaId}" class="btn btn-icon btn-text-secondary rounded-pill me-1" title="Ver empresa">
                ...
                <div class="dropdown d-inline-block">
                  ...
                  <div class="dropdown-menu dropdown-menu-end m-0">
                    <a href="editar_empresa.php?id=${empresaId}" class="dropdown-item">
                      <i class="icon-base ri ri-pencil-line me-2"></i>
                      <span class="align-middle">Editar</span>
                    </a>
                    <a href="javascript:;" class="dropdown-item" onclick="eliminarEmpresa(${empresaId})">
