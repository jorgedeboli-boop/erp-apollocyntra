<!-- JAVASCRIPT CUSTOM autoriazar_devoluciones - unique  -->
...
window.ListarFiltrosConfig = {
  ...
  filterIds: ['FiltroSucursal', 'FiltroEstado'],
...
<script src="parts/autorizar_devoluciones/unique/tables-datatables-load.js?v=<?php echo $vTablesDatatablesLoad; ?>"></script>
