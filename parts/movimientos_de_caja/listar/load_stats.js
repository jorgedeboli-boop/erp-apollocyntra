/**
 * Script para cargar estadísticas de movimientos de caja
...
function cargarEstadisticas() {
    console.log('Cargando estadísticas de movimientos de caja...');
...
function cargarEstadistica(tipo, elementoId, esMoneda = false) {
    console.log('Cargando estadística:', tipo);
    ...
    fetch('parts/movimientos_de_caja/listar/load_stats.php', {
        method: 'POST',
        headers: {
