...
function formatear_euro_informe_actual($valor)
{
...
try {
    ...
    $stmt = mysqli_prepare(
        $conexion,
        "UPDATE informe_actual SET total_gastos = ? WHERE id_informe = ? LIMIT 1"
    );
    ...
    echo json_encode([
        ...
        'total_gastos_formatted' => formatear_euro_informe_actual($total_gastos)
    ]);
} catch (Exception $e) {
