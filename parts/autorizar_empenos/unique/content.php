...
<?php require_once __DIR__ . '/../../universal/filtros_opciones_autorizaciones.php'; ?>
  <!-- Autorizaciones de Porcentajes List Table -->
  <div class="card">
    <div class="card-header border-bottom card-header-forms">
      <h5 class="card-title mb-0">Autorizaciones de Porcentajes</h5>
      <div class="d-flex justify-content-between align-items-center row gx-5 pt-4 gap-5 gap-md-0 select2-btn-height" id="autorizar_filtros_container">
        ...
        <div class="col-md-6 user_estado">
          <select id="FiltroEstado" class="form-select select2-filter text-capitalize select2-custom">
            <?php autorizaciones_imprimir_opciones_estado_empeno(); ?>
          </select>
        </div>
      </div>
    </div>
    <div class="card-datatable table-responsive">
      <table class="datatables-autorizaciones-porcentajes table border-top">
        <thead>
          <tr>
            <th>ID</th>
            <th>SUCURSAL</th>
...
<!-- Modal Autorizar Cambio de Intereses -->
<div class="modal fade" id="modalAutorizarIntereses" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header card-header-forms pb-3">
        <h5 class="modal-title">Autorizar cambio de porcentaje lote</h5>
                ...
                <div class="d-flex">
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2 w-100 text-center">
                      <h6 class="mb-0 w-100 text-primary">Porcentaje Original</h6>
            ...
            <div class="col-sm-6">
              <div class="bg-label-warning p-4 rounded-4">
                <div class="d-flex">
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2 w-100 text-center">
                      <h6 class="mb-0 w-100 text-warning">Nuevo Porcentaje</h6>
