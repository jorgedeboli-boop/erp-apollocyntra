<!-- JAVASCRIPT CUSTOM autorizar_sms - listar  -->
...
window.ListarFiltrosConfig = {
  ...
  filterIds: ['FiltroSucursal', 'FiltroEstadoSMS', 'FiltroEstadoAutorizado'],
  sucursalSelectId: 'FiltroSucursal',
...
<script src="parts/autorizar_sms/listar/tables-datatables-load.js?v=<?php echo $vTablesDatatablesLoad; ?>"></script>
