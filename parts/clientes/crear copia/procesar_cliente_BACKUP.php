...
try {
    ...
    try {
        ...
        mysqli_stmt_bind_param($stmt_clientes, 'ssisissii', $nombre, $apellido, $sucursal, $tipo_identificacion_texto, $tipo_identificacion, $identificacion, $nacionalidad_texto, $nacionalidad_id, $telefono, $usuario_id);
        ...
        /*
        $texto_action_user = "$usuario_nombre $usuario_apellido creó el cliente Nº '$id_cliente'";
        $id_action_user = "34";
