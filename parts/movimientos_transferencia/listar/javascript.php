...
window.FiltrosDinamicosConfig = {
  ...
  readyClass: 'movimientos-transferencia-filtros-ready',
...
<!-- JAVASCRIPT CUSTOM MOVIMIENTOS TRANSFERENCIA LISTAR -->
<!-- Scripts personalizados de movimientos transferencia -->
<?php
...
<script src="parts/movimientos_transferencia/listar/load_stats.js?v=<?php echo $vLoadStats; ?>"></script>
<script src="parts/universal/export-datatable-todos.js?v=<?php echo $vExportDatatableTodos; ?>"></script>
<script src="parts/movimientos_transferencia/listar/tables-datatables-load.js?v=<?php echo $vTablesDatatablesLoad; ?>"></script>
