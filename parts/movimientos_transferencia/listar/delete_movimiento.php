<?php
/**
 * Archivo para eliminar un movimiento por transferencia
 */
...
try {
    ...
    $queryCheck = "SELECT id FROM movimientos_transferencia WHERE id = ?";
    ...
    $query = "DELETE FROM movimientos_transferencia WHERE id = ?";
