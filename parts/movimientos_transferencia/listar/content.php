<div class="container-fluid flex-grow-1 container-p-y">
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="avatar">
              <div class="avatar-initial bg-label-primary rounded-circle">
                <div class="icon-base ri ri-exchange-line icon-26px"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Movimientos Transferencia Table -->
  <div class="card">
    <div class="card-header border-bottom card-header-forms">
      <h5 class="card-title mb-0" id="titulo-listados">Histórico de Movimientos por Transferencia</h5>
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-movimientos-transferencia table border-top">
        <thead>
          <tr>
            <th>ID</th>
            <th>Fecha</th>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalNuevoApunteLabel">Nuevo Movimiento por Transferencia</h5>
      ...
      <div class="modal-body">
        <form id="formNuevoApunte">
          ...
          <div class="alert alert-info mb-0">
            <small><i class="ri-information-line me-1"></i> Solo uno de los campos (Salida o Entrada) debe tener valor.</small>
          </div>
        </form>
      </div>
