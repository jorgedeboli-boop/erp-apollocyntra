...
/**
 * Paso manual: comprueba si la fecha indicada empieza un mes.
 * Copia adaptada de CRON/consultar-mes-inicio.php (no modifica CRON/).
 */
...
if (!$fila || empty($fila['id_numero_mes'])) {
    cron_linea('  No hay numero de mes que empiece en esa fecha.');
