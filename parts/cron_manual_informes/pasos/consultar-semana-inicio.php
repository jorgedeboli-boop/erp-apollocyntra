...
/**
 * Paso manual: comprueba si la fecha indicada empieza una semana.
 * Copia adaptada de CRON/consultar-semana-inicio.php (no modifica CRON/).
 */
...
if (!$fila || empty($fila['id_numero_semana'])) {
    cron_linea('  No hay numero de semana que empiece en esa fecha.');
