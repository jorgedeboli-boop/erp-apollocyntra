...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    var btn = document.getElementById('btnEditarTarjeta');
    if (btn) {
      btn.disabled = true;
      btn.innerHTML = '<span class="spinner-border me-1"></span>Actualizando...';
    }
    fetch('parts/tarjetas_banco_config/editar/procesar_editar_tarjeta.php', {
      method: 'POST',
      ...
      .then(function (data) {
        ...
        if (btn) {
          btn.disabled = false;
          btn.innerHTML = '<i class="icon-base ri ri-check-line me-2"></i>Actualizar tarjeta';
        }
      })
      .catch(function () {
