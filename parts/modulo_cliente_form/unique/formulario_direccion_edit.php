...
<div class="form-floating form-floating-outline mb-4">
  <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Calle, número, piso..." value="<?php echo isset($direccion_cliente['direccion']) ? htmlspecialchars($direccion_cliente['direccion']) : ''; ?>" required autocomplete="off" />
  <label for="direccion" class="form-label">Dirección *</label>
</div>

<div class="form-floating form-floating-outline mb-4">
  <select class="form-select select2" id="pais" name="pais" required autocomplete="off">
...
<div class="form-floating form-floating-outline mb-4">
  <select class="form-select select2" id="c_provincia" name="c_provincia" required autocomplete="off"
    <?php
...
<div class="form-floating form-floating-outline mb-4">
  <select class="form-select select2" id="c_poblacion" name="c_poblacion" required autocomplete="off"
    <?php
    ...
    if (isset($direccion_cliente['rel_id_poblacion']) && $direccion_cliente['rel_id_poblacion']) {
        ...
        if ($row_pobl = mysqli_fetch_assoc($result_pobl)) {
            echo '<option value="' . (int) $row_pobl['idpoblacion'] . '" selected>' . htmlspecialchars($row_pobl['poblacion']) . '</option>';
        }
...
<div class="form-floating form-floating-outline mb-4">
  <input type="text" class="form-control" id="codigo_postal" name="codigo_postal" placeholder="Código postal" value="<?php echo isset($direccion_cliente['codigo_postal']) ? htmlspecialchars($direccion_cliente['codigo_postal']) : ''; ?>" required autocomplete="off" />
  <label for="codigo_postal" class="form-label">Código Postal *</label>
</div>

<div class="form-floating form-floating-outline mb-4">
  <input type="text" class="form-control" id="observaciones_direccion" name="observaciones_direccion" placeholder="Observaciones Dirección" value="<?php echo isset($direccion_cliente['observaciones_direccion']) ? htmlspecialchars($direccion_cliente['observaciones_direccion']) : ''; ?>" autocomplete="off" />
