...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_movimiento_table = document.querySelector('.datatables-movimientos-tarjeta');
  ...
  const createFilterGrupo = function (containerClass, selectId, defaultOptionText) {
    return FD.createFilterAjax(
      ...
      selectId,
      defaultOptionText,
      'parts/movimientos_tarjeta/listar/get_grupos.php',
      function (data) {
  ...
  if (dt_movimiento_table) {
    ...
    window.dt_movimiento = new DataTable(dt_movimiento_table, {
      ...
      ajax: {
        url: 'parts/movimientos_tarjeta/listar/load_list.php',
        type: 'POST',
        data: function(d) {
  ...
  function cargarGruposMovimientos() {
    ...
    fetch('parts/movimientos_tarjeta/listar/get_grupos.php')
  ...
  const btnCrearApunteTarjeta = document.getElementById('btnCrearApunte');
  if (btnCrearApunteTarjeta) {
  btnCrearApunteTarjeta.addEventListener('click', function() {
    ...
    fetch('parts/movimientos_tarjeta/listar/create_movimiento.php', {
      method: 'POST',
      body: formData
    })
    .then(response => response.json())
  ...
  function abrirModalEditarMovimiento(idMovimiento) {
    ...
    fetch('parts/movimientos_tarjeta/listar/get_movimiento.php', {
      method: 'POST',
  ...
  const btnEliminarMovimientoTarjeta = document.getElementById('btnEliminarMovimiento');
  if (btnEliminarMovimientoTarjeta) {
  btnEliminarMovimientoTarjeta.addEventListener('click', function() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch('parts/movimientos_tarjeta/listar/delete_movimiento.php', {
          method: 'POST',
          body: formData
        })
        .then(response => response.json())
  ...
  const btnGuardarMovimientoTarjeta = document.getElementById('btnGuardarMovimiento');
  if (btnGuardarMovimientoTarjeta) {
  btnGuardarMovimientoTarjeta.addEventListener('click', function() {
    ...
    const formData = new FormData(form);
    fetch('parts/movimientos_tarjeta/listar/update_movimiento.php', {
      method: 'POST',
      body: formData
    })
    .then(response => response.json())
