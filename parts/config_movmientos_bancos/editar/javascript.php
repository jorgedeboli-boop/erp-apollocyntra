...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var form = document.getElementById('formEditarConfig');
  if (!form) return;
  ...
  form.addEventListener('submit', function (e) {
    ...
    var btn = document.getElementById('btnEditarConfig');
    if (btn) {
      btn.disabled = true;
      btn.innerHTML = '<span class="spinner-border me-1"></span>Actualizando...';
    }
    fetch('parts/config_movmientos_bancos/editar/procesar_editar_config.php', {
      method: 'POST',
      ...
      .then(function (data) {
        ...
        if (btn) {
          btn.disabled = false;
          btn.innerHTML = '<i class="icon-base ri ri-check-line me-2"></i>Actualizar';
        }
      })
      .catch(function () {
