...
$datev= $rsItem['fecha_vencimiento'];
$sqldatev=date('d-m-Y',strtotime($datev));
...
<td width="45%" style="text-align: right;">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		 <td height="10"  style="vertical-align:middle; font-size:15px; font-weight: bold;">Hoja resumen de operación para la  policia. Compra opción</td>
	    </tr>
	  <tr>
...
Nombre y apellido: '.$rsItem['nombre'].' '.$rsItem['apellido'].'<br />Fecha de nacimiento: '.$sqldaten.'<br />Nacionalidad: '.$rsItem['nacionalidad'].'</td>
...
<thead>
<tr>
  <td width="33%" style="text-align: center;">Nº de objetos: '.$smatoria.'</td>
  <td width="33%" style="text-align: center;">Importe en euros: '.$rsItem['precio_compra'].' €</td>
  <td width="33%" style="text-align: center;">Peso (gr): '.$rsItem['peso'].'</td>
</tr>
