...
//$sello_sucursal = '<div id="sello"><img src="http://18.202.145.164/photos/'.$sello_image.'"></div>';
...
$queryadelantos = " SELECT COUNT(id_adelanto_capital) AS TOTALADELANTOS FROM adelantos_capital WHERE id_lote_adelanto = '$lote' AND sucursal_adelanto = '$sucursal' ";
$Itemadelantos = mysql_query($queryadelantos, $conexion);
mysql_query("SET NAMES 'utf8'");
$rsItemadelantos = mysql_fetch_assoc($Itemadelantos);
$TOTALADELANTOS  = $rsItemadelantos['TOTALADELANTOS'];

$queryadelantose = " SELECT capital_antiguo FROM adelantos_capital WHERE id_lote_adelanto = '$lote' AND sucursal_adelanto = '$sucursal' LIMIT 1 ";
$Itemadelantose = mysql_query($queryadelantose, $conexion);
mysql_query("SET NAMES 'utf8'");
$rsItemadelantose = mysql_fetch_assoc($Itemadelantose);
...
$queryww = " SELECT nombre_empresa, cif_empresa FROM empresas WHERE id_empresa = $empresa_id ";
$Itemww = mysql_query($queryww, $conexion);
mysql_query ("SET NAMES 'utf8'");
$rsItemww = mysql_fetch_assoc($Itemww);
...
<div style="text-align: justify; font-style: italic; margin:0 0 15px 0;font-size:6pt;line-height:150%;">
...
<br><br>
<!-- RENOVACIONES -->
<div style=" height:auto; margin-top: 30pt; page-break-before:always;">
<br />
Renovaciones
...
<tbody>
';
$querys = " SELECT * FROM historico_renovaciones_$sucursal WHERE lote = $idl " ;
mysql_query ("SET NAMES 'utf8'");
$Itemas = mysql_query($querys, $conexion);
$i = 1;
while($row = mysql_fetch_assoc($Itemas)){
...
if ($proximo_vencimiento != '0000-00-00') {
...
$importe_renovacionw = $row['importe_renovacion'];
$importe_renovacionw = number_format($importe_renovacionw, 2, '.', ' ');
$html .= '<tr>
...
$html .='
<!-- ADELANTO CAPITAL -->
<div style=" height:auto; margin-top: 30pt; ">
...
<tbody>
';
$querysa = " SELECT * FROM adelantos_capital WHERE id_lote_adelanto = ". $idl ." and sucursal_adelanto = ". $sucursal ." " ;
mysql_query ("SET NAMES 'utf8'");
$Itemasa = mysql_query($querysa, $conexion);
$is = 1;
while($rowa = mysql_fetch_assoc($Itemasa)){
...
';
$mpdf->WriteHTML($html);
// $mpdf->Output('Ficha Contrato Lote Nº '.$idl.'.pdf','I');
$mpdf->Output();
exit;
?>