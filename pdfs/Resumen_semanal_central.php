...
$query = "SELECT * FROM envios INNER JOIN sucursal ON envios.sucursal_remitente=sucursal.id_sucursal WHERE id_envio = $id_envio ";
...
<table  style="background-color:#ffffff" width="100%" cellpadding="10" cellspacing="0" >
	...
	<tr>
     ...
     <th style="background:#FFFFFF;"></th>
     <th><h3 class="titulo"><?php echo $rsItem['nombre_sucursal']; ?></h3></th>
  </tr>
...
<table border="1" bordercolor="#666666" style="background-color:#ffffff" width="100%" cellpadding="1" cellspacing="0" >
   ...
   <tr>
		<td>
      <?php 
$query = "SELECT * FROM lotes_$id_sucursal WHERE envio_numero = $id_envio ";
$Item = mysql_query($query, $conexion);
mysql_query ("SET NAMES 'utf8'");
...
<table border="1" bordercolor="#666666" style="background-color:#ffffff" width="100%" cellpadding="1" cellspacing="0" >
   ...
   <tr>
		<td><?php if(!$rsItem['observaciones_envio']){ echo $rsItem['observaciones_envio']; }else{echo "Envío sin observaciones"; } ?></td>
	</tr>
