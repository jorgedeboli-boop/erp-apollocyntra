...
<table width="100%" cellspacing="0" cellpadding="0" class="table tablearticulo  " >
  ...
  <tr>
    ...
    <td colspan="2" width="80%" height="60" class="table td"><p>Clase</p>
    <p><strong>&nbsp;</strong></p></td>
  </tr>
  <tr>
    <td class="table td">
		 <p>Peso neto (gr.) <strong>&nbsp;</strong></p>
		 <p>Peso bruto (gr.) <strong>&nbsp;</strong></p>
    </td>
...
mysql_query ("SET NAMES 'utf8'");
$Item = mysql_query($query, $conexion);
$rsIteme = mysql_fetch_assoc($Item);
$pesobruto = $rsIteme['peso_bruto'];
...
';
$mpdf->WriteHTML($html);
//$mpdf->Output('Contrato sin articulos Nº '.$rsItem['id_lote'].'.pdf','D');
$mpdf->Output(); 
exit;
?>