...
if ($rsItem['tipo_identificacion'] == dni) {
  $documento = "checked='checked'";
  $otrodocumento = "";
} else {
  $documento = "";
  $otrodocumento = "checked='checked'";
  $otrod = $rsItem['tipo_identificacion'];
}

if ($rsItem['nacionalidad'] == Española) {
  $nacion = "checked='checked'";
  $otronacion = "";
} else {
  $nacion = "";
  $otronacion = "checked='checked'";
  $otron = $rsItem['nacionalidad'];
}

if ($rsItem['sexo'] == Hombre) {
  $sexhombre = "checked='checked'";
  $sexmujer = "";
} else {
  $sexhombre = "";
  $sexmujer = "checked='checked'";
}

if ($rsItem['compra_opcion'] == si) {
  $empenado = "checked='checked'";
  $comprado = "";
} else {
  $empenado = "";
  $comprado = "checked='checked'";
}
...
<table width="100%"  cellspacing="0" cellpadding="0" class="table" >
  <tr>
    ...
    <p><strong>'. $nombreempresa.' '. $nombresucursal.'</strong></p></td>
    <td width="37%" class="table td"><p>IFZ/NIF</p>
    <p><strong>'. $numeroidentificaciontienda.'</strong></p></td>
  </tr>
  <tr>
    <td class="table td"><p>Kalea/Calle</p>
    <p><strong>'. $calletienda.'</strong></p></td>
    <td class="table td"><p>Zk./Nº</p>
    <p><strong>'. $numerocalle.'</strong></p></td>
  </tr>
  <tr>
    <td class="table td"><p>Udalerria/Localidad</p>
    <p><strong>'. $poblaciontienda.'</strong></p></td>
    <td class="table td"><p>Lurraldea/Provincia</p>
    <p><strong>'. $provinciatienda.'</strong></p></td>
  </tr>
</table>
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  ...
  <tr>
   <td class="table td"><p>Kontrato mota/Tipo de contrato</p>
	...
	<input type="checkbox" name="radio"  '. $empenado.' > Erosteko aukera/Opción recompra
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  ...
  <tr>
    ...
    <p><strong>'. $rsItem["telefono"].'</strong></p></td>
  </tr>
  <tr>
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  <tr>
    <td style=" height:50px; padding-top:10px;"><h3>Kontratu honen objektua/k (banakakoak)/Objeto/s del presente contrato (individualizados)</h3></td>
  </tr>
</table>
...
while ($row = mysql_fetch_assoc($Itemas)) {
  ...
  if ($row['active_inscripciones'] == si) {
    $inscsi = "checked='checked'";
    $inscno = "";
  } else {
    $inscsi = "";
    $inscno = "checked='checked'";
  }

  if ($row['active_piedras'] == si) {
    $piedcsi = "checked='checked'";
    $piedno = "";
  } else {
    $piedcsi = "";
    $piedno = "checked='checked'";
  }
  ...
  <table width="100%" cellspacing="0" cellpadding="0" class="table tablearticulo" >
    <tr>
      ...
      <td colspan="2" width="80%" height="60" class="table td" style=" height:70px;"><p>Mota/Clase</p>
    ...
    <td class="table td" style=" height:50px; padding-top:10px;"><p>Metalak/Metales </p>
      <p><strong>'. $tipo_de_articulo.'</strong></p></td>
      <td class="table td" style=" height:50px; padding-top:10px;"><p>Kilate-pisua/Peso quilates</p>
      <p><strong>'. $ley.'</strong></p></td>
    </tr>
    <tr>
      <td class="table td" style=" height:50px; padding-top:10px;"><p>Grabaketak/Grabaciones</p>
      <p><input type="checkbox" name="radio" '. $inscsi.' > Bai/Si
    <input type="checkbox" name="radio" '. $inscno.' > Ez/No
    </p>
    </td>
      <td  colspan="2" class="table td" style=" height:70px;"><p>Detaileak/Detalles  </p>
      <p><strong>'. $inscripciones.'</strong></p></td>
    </tr>
    <tr>
      <td class="table td" style=" height:50px; padding-top:10px;"><p>Harriak/Piedras</p>
    ...
    <tr>
      <td  colspan="2"  width="47%" class="table td" style=" height:50px; padding-top:10px;"><p>Prezioa / Precio abonado</p>
      <p><strong>'. $precio_compra_articulo.' €</strong></p></td>
      <td width="53%" class="table td" style=" height:50px; padding-top:10px;"><p>Objektu argazkia (beharrezkoa)/Fotografia detallada objeto</p>
      <p><input type="checkbox" name="radio" checked="checked"> Bai/Si</p></td>
    </tr>
    <tr>
      <td  colspan="3"  width="100%" class="table td" height="15" style=" height:50px; padding-top:10px;"><p>(*) Salmenta data / Fecha venta posterior: <strong></strong></22wwp>
    </td>
    </tr>
  </table>
...
<table width="100%" cellspacing="0" cellpadding="0" class="table">
  <tr>
    <td align="center">
      <h4>En '. $poblaciontienda.' a '. $d.' (ko) De '. $m.' (ren) de '. $a.' (e)a</h4>
    </td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
  <tr>
    <td>
      <h6>Establezimenduaren zigilua eta sinadura /<br /> Sello y firma del establecimiento</h6>
    </td>
    <td>
      <h6>Interesatuaren sinadura /<br /> Firma del interesado</h6>
    </td>
    <td>
      <h6>&nbsp;<br /> &nbsp;</h6>
    </td>
    <td align="right" style="text-align:right;">
      <h5>&nbsp; <br />Folio Zk / Nº Pág.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
    </td>
  </tr>
</table>
