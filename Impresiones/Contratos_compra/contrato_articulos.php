...
<table width="100%" cellspacing="0" cellpadding="0" class="table" style=" color:#ffffff; border:#FFFFFF; visibility:hidden;"  >
  ...
  <tr>
   <td class="table td"><p>Tipo de contrato</p>
	...
	<p><input class="inputesocndidos" type="checkbox" name="radio" <?php echo $comprado; ?> > Compraventa
	
	<input class="inputesocndidos" type="checkbox" name="radio"  <?php echo $empenado; ?> > Empeño
	
	</p></td>
	
	<td class="table td"><p>Papeleta empeño</p>
	
	<p><input class="inputesocndidos" type="checkbox" name="radio" > Si
	
	<input class="inputesocndidos" type="checkbox" name="radio" checked="checked" > No
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" style=" color:#ffffff; border:#FFFFFF; visibility:hidden;"  >
  ...
  <tr>
    ...
    <td class="table td">
	 <p>Tipo</p>
    <p>
	 <input class="inputesocndidos" type="checkbox" name="radio" <?php echo $documento; ?> > DNI
	 <input class="inputesocndidos" type="checkbox" name="radio" <?php echo $otrodocumento; ?> > Otro (indicar):<strong> <?php echo $otrod; ?></strong>
	 </p>
	 </td>
  </tr>
  ...
  <tr>
   <td class="table td">
	<p>Sexo</p>
	<p>
	<input class="inputesocndidos" type="checkbox" name="radio" <?php echo $sexhombre; ?> >Varón
	<input class="inputesocndidos" type="checkbox" name="radio" <?php echo $sexmujer; ?> >Mujer
	</p>
	</td>
   <td class="table td">
  ...
  <tr>
    ...
    <p><input class="inputesocndidos" type="checkbox" name="radio" <?php echo $nacion; ?> >España
	 <input class="inputesocndidos" type="checkbox" name="radio" <?php echo $otronacion; ?> >Otro (indicar):<strong><?php echo $otron; ?></strong>
	 </p>
	 </td>
  </tr>
  <tr>
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  <tr>
    <td style=" height:50px; padding-top:10px; color:#ffffff; border-color:#FFFFFF; visibility:hidden;"><h3>Objeto/s del presente contrato (individualizados)</h3></td>
  </tr>
</table>
...
<table width="100%" cellspacing="0" cellpadding="0" class="table tablearticulo" style="margin: 10px 0;" >
  <tr>
    <td width="20%" class="table td"><p style="color:#ffffff; visibility:hidden;" >Nº orden</p>
    <p><strong><?php echo $id_articulo_lote; ?></strong></p></td>
    <td colspan="2" width="80%" height="60" class="table td" style=" height:70px;"><p style="color:#ffffff; visibility:hidden;" >Clase</p>
  ...
  <tr>
    <td class="table td" style=" height:50px; padding-top:10px;">
	 ...
	 <td class="table td" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >Metales </p>
    <p><strong><?php echo $tipo_de_articulo; ?></strong></p></td>
    <td class="table td" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >Peso quilates</p>
    <p><strong><?php echo $ley; ?></strong></p></td>
  </tr>
  <tr>
    <td class="table td" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >Grabaciones</p>
    <p><input type="checkbox" name="radio" <?php echo $inscsi; ?> > Si
	 <input type="checkbox" name="radio" <?php echo $inscno; ?> > No
	 </p>
	 </td>
    <td  colspan="2" class="table td" style=" height:70px;"><p style="color:#ffffff; visibility:hidden;" >Detalles  </p>
    <p><strong><?php echo $inscripciones; ?></strong></p></td>
  </tr>
  <tr>
    <td class="table td" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >Piedras</p>
  ...
  <tr>
    <td  colspan="2"  width="47%" class="table td" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >Precio abonado</p>
    <p><strong><?php echo $precio_compra_articulo; ?> €</strong></p></td>
    <td width="53%" class="table td" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >Fotografia detallada objeto</p>
    <p><input type="checkbox" name="radio" checked="checked"> Si</p></td>
  </tr>
  <tr>
    <td  colspan="3"  width="100%" class="table td" height="15" style=" height:50px; padding-top:10px;"><p style="color:#ffffff; visibility:hidden;" >(*) Fecha venta posterior: <strong></strong></22wwp>
	 </td>
  </tr>
</table>
		 ...
		 //ESTER JOYERIA
                ...
                case 18:
                        $texto_legal = 'De acuerdo con los derechos que le confiere la normativa vigente y aplicable en protección de datos podrá
                                ...
                                consentimiento prestado para el tratamiento de los mismos, dirigiendo su petición a la dirección C/VELAZQUEZ 10, 1ª PLANTA,
                                28001, MADRID o al correo electrónico esjollerias19@gmail.com. Podrá dirigirse a la Autoridad de
                ...
                case 50:
                        $texto_legal = ' (De acuerdo con los derechos que le confiere la normativa vigente y aplicable en protección de datos podrá
                                        ejercer los derechos de acceso, rectificación, limitación de tratamiento, supresión (“derecho al olvido”),
                                        portabilidad y oposición al tratamiento de sus datos de carácter personal así como la revocación del
                                        consentimiento prestado para el tratamiento de los mismos, dirigiendo su petición a la dirección C/Velázquez 10, 1ª PLANTA
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" style="color:#ffffff; visibility:hidden;"  >
  <tr>
    <td align="center"><h4>En <?php echo $rsItem['poblacion_tienda']; ?>  a <?php echo $d; ?> de  <?php echo $m; ?> de <?php echo $a; ?></h4></td>
  </tr>
</table>
