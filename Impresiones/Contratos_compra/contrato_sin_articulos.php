...
<table width="100%" cellspacing="0" cellpadding="0" class="table tablearticulo" style="margin: 10px 0;" >
  <tr>
    <td width="20%" class="table td"><p>Nº orden <? echo $i; ?></p>
    <p><strong><?php echo $id_articulo_lote; ?></strong></p></td>
    <td colspan="2" width="80%" height="30" class="table td" style=" height:30px;"><p>Clase</p>
    <p><strong><?php echo $descripcion_articulo; ?></strong></p></td>
  </tr>
  <tr>
    <td class="table td" style=" height:30px; padding-top:10px;">
    </td>
	 <td class="table td" style=" height:30px; padding-top:10px;"><p>Metales </p>
    </td>
    <td class="table td" style=" height:30px; padding-top:10px;"><p>Peso quilates</p>
    </td>
  </tr>
  <tr>
    <td class="table td" style=" height:30px; padding-top:10px;"><p>Grabaciones</p>
    
	 </td>
    <td  colspan="2" class="table td" style=" height:30px;"><p>Detalles  </p>
    </td>
  </tr>
  <tr>
    <td class="table td" style=" height:30px; padding-top:10px;"><p>Piedras</p>
	 
	 </td>
	 <td class="table td" style=" height:30px; padding-top:10px;"><p>Peso quilates</p>
    </td>
    <td class="table td" style=" height:30px;"><p>Clase</p>
    </td>
  </tr>
  <tr>
    <td  colspan="2"  width="47%" class="table td" style=" height:30px; padding-top:10px;"><p>Precio abonado</p>
    </td>
    <td width="53%" class="table td" style=" height:30px; padding-top:10px;"><p>Fotografia detallada objeto</p>
    </td>
  </tr>
  <tr>
    <td  colspan="3"  width="100%" class="table td" height="15" style=" height:30px; padding-top:10px;"><p>(*) Fecha venta posterior: <strong></strong></22wwp>
	 </td>
  </tr>
</table>
