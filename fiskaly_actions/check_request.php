...
// Obtener URL completa desde donde viene la petición
$url_completa_origen = $dominio_permitido."/venta.php?categoria=ventas&page=venta&id_venta=".$_GET['id_venta']."&sucursal_venta=".$_GET['sucursal_venta'];
