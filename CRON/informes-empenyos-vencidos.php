...
/**
 * Informe diario: empeños vencidos en la fecha del informe.
 * Lee lotes_joyeria (vista unificada alimentada por triggers desde lotes_{id}).
 */

$ctx = cron_informe_contexto('informes-empenyos-vencidos');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-empenyos-vencidos preparando consulta de informes.');
    return;
}
