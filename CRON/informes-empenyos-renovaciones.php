...
/**
 * Informe diario: renovaciones de empeños.
 * Lee historico_renovaciones_gobal (tabla global por sucursal_id).
 */

$ctx = cron_informe_contexto('informes-empenyos-renovaciones');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-empenyos-renovaciones preparando consulta de informes.');
    return;
}
