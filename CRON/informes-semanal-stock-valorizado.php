...
cron_informe_semanal_recorrer_abiertos('informes-semanal-stock-valorizado', function ($informe, $conexion) {
    ...
    $sql = 'UPDATE informe_semanal SET coste_stock_valorizado = ?, stock_articulos = ?, stock_valorizado_eruo = ?, coheficiente_stock_valorizado = ? WHERE id_informe = ?';
