...
$identificador_venta = $rsItemFR['identificador_venta'];
...
$sql_factura_fiskaly = "SELECT * FROM facturas_fiskaly_cache WHERE rel_id_venta = $identificador_venta AND id_sucursal = $sucursal_factura AND numero_factura = $numero_factura ";
...
$html .= '
	...
	<div style="width: 340px; height: 100px; float: right">
		...
		<div style="width: 200px; height: 80px; float: left; padding: 5px 0px; ">
			...
			<p class="texto-b" style="text-align: left;">'.$prefijo_factura.'-'.$numero_factura.'</p>
...
$html .='
<div style="width: 330px; position: absolute; bottom: 250px; left: 75px; ">
...
$mpdfone->Output('Factura-'.$prefijo_factura.'-'.$anyo_factura.''.$numero_factura.'.pdf','D');
