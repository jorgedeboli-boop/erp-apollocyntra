...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  <tr>
    <td align="center"><h2>HOJA - CONTRATO VENTA OBJETOS METALES PRECIOSOS</h2></td>
  </tr>
  <tr>
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  ...
  <tr>
   <td class="table td"><p>Kontrato mota/Tipo de contrato</p>
	...
	<p><input type="checkbox" name="radio" <?php echo $comprado; ?> > Salerosi/Compraventa
	
	<input type="checkbox" name="radio"  <?php echo $empenado; ?> > Bahitura/Empeño
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  ...
  <tr>
    ...
    <td class="table td">
	 <p>Mota/Tipo</p>
    <p>
	 <input type="checkbox" name="radio" <?php echo $documento; ?> > ENA/DNI
	 <input type="checkbox" name="radio" <?php echo $otrodocumento; ?> > Beste bat (zehaztu)/Otro (indicar):<strong> <?php echo $otrod; ?></strong>
	 </p>
	 </td>
  </tr>
  ...
  <tr>
   <td class="table td">
	<p>Sexua/Sexo</p>
	<p>
	<input type="checkbox" name="radio" <?php echo $sexhombre; ?> >Gizonezkoa/Varón
	<input type="checkbox" name="radio" <?php echo $sexmujer; ?> >Emakumezkoa/Mujer
	</p>
	</td>
   <td class="table td">
  ...
  <tr>
    ...
    <p><input type="checkbox" name="radio" <?php echo $nacion; ?> >Espainia/España
	 <input type="checkbox" name="radio" <?php echo $otronacion; ?> >Beste bat (zehaztu)/Otro (indicar):<strong><?php echo $otron; ?></strong>
	 </p>
	 </td>
...
<div style="text-align: left; font-style: italic; margin:5px 0 0 0; color:#000000; font-size:5pt; ">(*) Objektuen salmenta datak ez du inola ere lotuko oraingo kontratuko interesatuari, eta kontratu honen sinadurako dataren ondoren egingo da / La fecha de venta de los objetos, por parte del establecimiento, no vincula en ningún caso al vendedor-interesado del presente contrato, y será siempre posterior a la fecha de firma del mismo.
<br />
Operación sujeta al régimen especial de bienes usados según artículo 135 de la ley 37/1992 del 28 de diciembre del IVA. / Abenduaren 28 ko 37/1992 legearen 135 artikuluaren arabera, eragiketa hau erabilitako ondasunen erregimen berezietan dago oinarrituta.
...
<table width="100%" cellspacing="0" cellpadding="0" class="table" >
  <tr>
    <td align="center"><h4>En <?php echo $poblaciontienda; ?> a <?php echo $d; ?> (ko) De <?php echo $m; ?> (ren) de <?php echo $a; ?>  (e)a</h4></td>
  </tr>
</table>
