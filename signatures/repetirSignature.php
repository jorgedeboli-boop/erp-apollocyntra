...
try {
    ...
    // Actualizar firma para repetirla (resetear estados)
    $query = "UPDATE Signatures 
              SET cancel_signature = 'false', 
                  state_signature = 'false', 
                  auth_no_signature = 'false' 
              WHERE id_signature = ?";
    ...
    if (!mysqli_stmt_execute($stmt)) {
        throw new Exception('Error al resetear firma: ' . mysqli_stmt_error($stmt));
    }
    ...
    echo json_encode(array(
        ...
        'message' => 'Firma reseteada correctamente'
    ));
