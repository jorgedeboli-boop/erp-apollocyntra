...
if($tipo_identificacion_cliente == 'dni' || $tipo_identificacion_cliente == 'nie'){
    $nacional = 'true';
}else{
    $nacional = 'false';
}
    ...
    $json_fiskaly = array(
        "content" => array(
            ...
            "invoice" => array(
                ...
                array(
                    "id" => array(
                        "type" => $tipo_identificacion_cliente,
                        "number" => $recipient_tax_number,
                        "legal_name" => $recipient_legal_name,
