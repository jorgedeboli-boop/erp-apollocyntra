...
/**
 * Informe diario: ventas a plazos del dia.
 */

$ctx = cron_informe_contexto('informes-ventas-plazos');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-ventas-plazos preparando consulta de informes.');
    return;
}
