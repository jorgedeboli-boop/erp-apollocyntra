...
/**
 * Informe actual: devoluciones del dia.
 */

$ctx = cron_informe_actual_contexto('informes-actual-devoluciones');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-actual-devoluciones preparando consulta de informes.');
    return;
}
