...
/**
 * Informe diario: stock valorizado en venta por sucursal.
 */

$ctx = cron_informe_contexto('informes-stock-valorizado');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-stock-valorizado preparando consulta de informes.');
    return;
}
