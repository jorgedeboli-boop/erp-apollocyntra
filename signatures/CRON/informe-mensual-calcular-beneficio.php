...
cron_informe_mensual_recorrer_abiertos('informe-mensual-calcular-beneficio', function ($informe, $conexion) {
    ...
    $sqlUpdate = 'UPDATE informe_mensual SET beneficio_tienda = ?, sector_mas_beneficio = ?, sector_menos_beneficio = ? WHERE id_informe = ?';
