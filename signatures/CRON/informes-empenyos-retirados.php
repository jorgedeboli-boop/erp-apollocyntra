...
/**
 * Informe diario: empeños retirados (importe desde historico_renovaciones_gobal).
 * Lotes: lotes_joyeria (vista unificada alimentada por triggers desde lotes_{id}).
 */

$ctx = cron_informe_contexto('informes-empenyos-retirados');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-empenyos-retirados preparando consulta de informes.');
    return;
}
