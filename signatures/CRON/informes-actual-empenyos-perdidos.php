...
/**
 * Informe actual: empeños perdidos en la fecha del informe.
 * Lee lotes_joyeria (vista unificada alimentada por triggers desde lotes_{id}).
 */

$ctx = cron_informe_actual_contexto('informes-actual-empenyos-perdidos');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-actual-empenyos-perdidos preparando consulta de informes.');
    return;
}
