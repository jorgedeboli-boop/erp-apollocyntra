...
/**
 * Informe diario: entradas y salidas de caja del dia.
 */

$ctx = cron_informe_contexto('informes-caja');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-caja preparando consulta de informes.');
    return;
}
