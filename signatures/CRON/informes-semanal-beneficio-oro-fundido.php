...
cron_informe_semanal_recorrer_abiertos('informes-semanal-beneficio-oro-fundido', function ($informe, $conexion) {
    ...
    $sqlUpdate = 'UPDATE informe_semanal SET beneficio_fundicion_oro = ? WHERE id_informe = ?';
