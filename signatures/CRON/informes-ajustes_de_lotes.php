...
/**
 * Informe diario: ajustes de lotes.
 * (Pendiente de implementar la lógica de cálculo.)
 */

$ctx = cron_informe_contexto('informes-ajustes_de_lotes');
if (!$ctx) {
    return;
}
...
if (!$stmtInformes) {
    cron_linea('ERROR informes-ajustes_de_lotes preparando consulta de informes.');
    return;
}
