...
try {
    ...
    $where = "WHERE l.cliente = ? AND (l.compra_opcion <> 'si' OR l.compra_opcion IS NULL OR l.compra_opcion = '')";
    $params = [$idCliente];
    $types = 'i';
    ...
    $sqlTotalAll = "SELECT COUNT(*) AS total FROM lotes_joyeria l WHERE l.cliente = ? AND (l.compra_opcion <> 'si' OR l.compra_opcion IS NULL OR l.compra_opcion = '')";
    ...
    while ($row = mysqli_fetch_assoc($rs)) {
        ...
        $data[] = [
            ...
            htmlspecialchars((string) ($row['peso'] ?? '')),
