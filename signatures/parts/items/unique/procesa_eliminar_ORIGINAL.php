...
try {
    ...
    $query_check = "SELECT id_type_Item, itemName, typ_item, fhater_item FROM itemsSections WHERE id_type_Item = ?";
    ...
    mysqli_stmt_bind_result($stmt_check, $id_item, $itemName, $typ_item, $fhater_item);
    mysqli_stmt_fetch($stmt_check);
    mysqli_stmt_close($stmt_check);
    
    error_log("Item encontrado: ID=$id_item, Nombre=$itemName, Tipo=$typ_item, Padre=$fhater_item");
