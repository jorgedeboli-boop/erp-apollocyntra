...
window.FiltrosDinamicosConfig = {
  ...
  readyClass: 'movimientos-caja-filtros-ready',
...
<!-- JAVASCRIPT CUSTOM MOVIMIENTOS DE CAJA LISTAR -->
<!-- Scripts personalizados de movimientos de caja -->
<?php
...
<script src="parts/movimientos_de_caja/listar/load_stats.js?v=<?php echo $vLoadStats; ?>"></script>
<script src="parts/universal/export-datatable-todos.js?v=<?php echo $vExportDatatableTodos; ?>"></script>
<script src="parts/movimientos_de_caja/listar/tables-datatables-load.js?v=<?php echo $vTablesDatatables; ?>"></script>
