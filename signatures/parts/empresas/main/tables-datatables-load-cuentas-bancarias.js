...
$(document).ready(function() {
    ...
    if ($('.datatables-cuentas-bancarias').length) {
        const tableCuentasBancarias = $('.datatables-cuentas-bancarias').DataTable({
            ajax: {
                url: 'parts/empresas/main/get_cuentas_bancarias.php',
                type: 'GET',
                data: function(d) {
            ...
            order: [[3, 'desc']], // Por fecha de creación (misma lógica que tarjetas / sucursales)
            pageLength: 10,
            lengthChange: false,
            language: {
            ...
            drawCallback: function(settings) {
                ...
                if (settings.json && settings.json.total === 0) {
                    $('.datatables-cuentas-bancarias tbody').html(
                        ...
                        'No hay cuentas bancarias configuradas para esta empresa</td></tr>'
                    );
                }
            }
        });
