...
window.FiltrosDinamicosConfig = {
  containerId: 'collapse_filtros_fiskaly',
  readyClass: 'fiskaly-filtros-ready'
};
</script>
<script src="parts/universal/filtros-dinamicos-listar.js?v=<?php echo $vFiltrosDinamicos; ?>"></script>
<script src="parts/fiskaly_manager/listar/load_stats.js?v=<?php echo $vLoadStats; ?>"></script>
<script src="parts/fiskaly_manager/listar/tables-datatables-load.js?v=<?php echo $vTablesDatatablesLoad; ?>"></script>
